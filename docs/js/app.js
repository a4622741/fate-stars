...
const MAP_CITIES={
  ...
  iron_crown:{name:'鐵冠城',cx:120,cy:120,size:5,kingdom:'fog_mt',desc:'霧山聯邦北方要塞，守備嚴密，礦脈豐富。',keywords:['鐵冠城','鐵冠','冠城'],
  ...
  grey_haven:{name:'灰港鎮',cx:90,cy:185,size:4,kingdom:'fog_mt',desc:'霧山聯邦西端漁港，海霧終年不散，走私猖獗。',keywords:['灰港鎮','灰港','漁港'],
  ...
  rust_city:{name:'鏽城',cx:360,cy:255,size:6,kingdom:'central',desc:'前帝都廢墟，帝國崩裂後百廢待興。',keywords:['鏽城','廢都','帝都','鏽都'],
  ...
  golden_bridge:{name:'金橋城',cx:400,cy:178,size:5,kingdom:'central',desc:'中央王國東部商貿樞紐，連接東海與內陸的咽喉。',keywords:['金橋城','金橋','橋城','大橋'],
  ...
  crown_peak:{name:'王冠峰',cx:290,cy:105,size:4,kingdom:'central',desc:'中央王國北境要塞，俯瞰翠林域與霧山聯邦交界。',keywords:['王冠峰','王冠','冠峰','瞭望塔'],
  ...
  fog_sea_pass:{name:'霧海關',cx:545,cy:248,size:5,kingdom:'east_sea',desc:'東海王國南端要塞，控制海上航路。',keywords:['霧海關','霧海','海關'],
  ...
  coral_bay:{name:'珊瑚灣',cx:555,cy:180,size:4,kingdom:'east_sea',desc:'東海王國漁村，盛產珊瑚與珍珠，海盜出沒。',keywords:['珊瑚灣','珊瑚','海灣'],
  ...
  elder_grove:{name:'古樹隱村',cx:335,cy:48,size:3,kingdom:'forest',desc:'翠林深處的隱匿聚落，居住著最古老的森民與隱士。',keywords:['古樹隱村','隱村','古樹','禁忌書庫'],
  ...
  // ═══ 南荒 ═══
  dragon_valley:{name:'龍牙砦',cx:415,cy:328,size:5,kingdom:'wasteland',desc:'南荒廢棄要塞，尋寶者與亡命之徒聚集。',keywords:['龍牙砦','龍牙','龍谷','古龍'],
  ...
  sand_gate:{name:'沙門城',cx:320,cy:340,size:4,kingdom:'wasteland',desc:'南荒北境的關城，是進入荒野的最後補給站。',keywords:['沙門城','沙門','南荒','荒野'],
  ...
  // ═══ 霜嶺 ═══
  frost_keep:{name:'霜守堡',cx:150,cy:38,size:4,kingdom:'north_ice',desc:'北方極寒之地的孤堡，帝國時代的邊防遺址，現由流亡騎士團駐守。',keywords:['霜守堡','霜守','霜嶺','冰堡','騎士團'],
  ...
  // ═══ 影沼地 ═══
  shadow_marsh:{name:'影沼鎮',cx:115,cy:310,size:4,kingdom:'shadow_marsh',desc:'西南沼澤中的隱秘聚落，瘴氣瀰漫，藥師與亡命之徒藏身於此。',keywords:['影沼鎮','影沼','沼澤','瘴氣'],
