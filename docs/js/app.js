...
const MAP_CITIES={
  // ═══ 霧山聯邦 ═══
  iron_fog:{name:'鐵霧城',cx:175,cy:215,size:7,kingdom:'fog_mt',desc:'霧山聯邦工業重城，終年霧不散。代理城主：恩佐·卡羅。',keywords:['鐵霧城','鐵霧','霧城','碼頭區','中央廣場'],
  ...
  // ═══ 中央王國 ═══
  silver_moon:{name:'銀月城',cx:340,cy:148,size:8,kingdom:'central',desc:'中央王國最大商業都市，各路英雄匯聚，情報市場繁盛。',keywords:['銀月城','銀月','月城','月橋'],
  ...
  // ═══ 東海王國 ═══
  east_port:{name:'東港城',cx:510,cy:155,size:7,kingdom:'east_sea',desc:'東海王國大港，海貿繁盛，情報人員眾多。',keywords:['東港城','東港','港城','東海'],
  ...
  // ═══ 翠林域 ═══
  jade_forest:{name:'翠林城',cx:290,cy:65,size:5,kingdom:'forest',desc:'翠林域精靈聚居地，外人不易進入。',keywords:['翠林城','翠林','精靈','世界樹'],
